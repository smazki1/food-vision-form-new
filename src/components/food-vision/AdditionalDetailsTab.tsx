      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            {additionalDetails.brandingMaterials && (
        ...
        <div className="space-y-2">
          ...
          <Textarea 
            id="generalNotes" 
            value={additionalDetails.generalNotes} 
            onChange={e => setAdditionalDetails(prev => ({...prev, generalNotes: e.target.value}))} 
            placeholder="הוסף הערות כלליות או בקשות מיוחדות" 
