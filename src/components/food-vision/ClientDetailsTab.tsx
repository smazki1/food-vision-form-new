  ...
  return <div className="space-y-6 animate-fade-in">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="phoneNumber" name="phoneNumber" type="tel" value={clientDetails.phoneNumber} onChange={handleChange} placeholder="הזן מספר טלפון" required className={!validatePhone(clientDetails.phoneNumber) && clientDetails.phoneNumber ? "border-destructive" : ""} />
          {!validatePhone(clientDetails.phoneNumber) && clientDetails.phoneNumber && <p className="text-destructive text-sm">מספר טלפון לא תקין</p>}
        </div>

        <div className="space-y-2">
          <Label htmlFor="email">כתובת דוא"ל *</Label>
          <Input id="email" name="email" type="email" value={clientDetails.email} onChange={handleChange} placeholder="הזן כתובת דוא״ל" required className={!validateEmail(clientDetails.email) && clientDetails.email ? "border-destructive" : ""} />
