...
import { Info, Upload, Check, AlertTriangle } from "lucide-react";
...
const ImagesTabContent = ({
  ...
  // Check if there is a main image selected
  ...
  return (
    <div className="space-y-6">
      <Tabs defaultValue="upload">
        ...
        <TabsContent value="originals" className="pt-6">
          {/* Original images section - this would show the client's original reference images */}
          <div className="space-y-6">
            <h3 className="text-md font-medium">תמונות מקוריות להשוואה</h3>
            {/* This would need to be implemented based on how original images are stored */}
            <p className="text-muted-foreground text-center py-10">
              אין תמונות מקוריות זמינות להשוואה
            </p>
          </div>
        </TabsContent>
      </Tabs>
