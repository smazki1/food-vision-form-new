...
import { Store, Sparkles, ChevronDown } from 'lucide-react';

interface CombinedDetailsStepProps {
  errors: Record<string, string>;
}

const CombinedDetailsStep: React.FC<CombinedDetailsStepProps> = ({ errors }) => {
    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        <div className="flex items-center justify-center mb-4">
          <Store className="w-8 h-8 text-orange-500 ml-2" />
        ...
        <p className="text-gray-600">
          הזינו את שם המסעדה ופרטי הפריט שברצונכם להעלות
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
          <IconInput
            ...
            name="restaurantName"
            label="שם המסעדה"
            placeholder="הזינו את שם המסעדה המדויק"
          ...
          <p className="text-xs text-orange-700 mt-1">
            * חשוב להזין את שם המסעדה בדיוק כפי שהוא רשום במערכת
          </p>
        </div>
