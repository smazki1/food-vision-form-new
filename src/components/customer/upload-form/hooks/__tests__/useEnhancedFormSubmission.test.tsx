...
describe('useEnhancedFormSubmission - Comprehensive Tests', () => {
        ...
        dishes: [
          {
            ...
            specialNotes: '',
            referenceImages: [new File(['img1'], 'img1.jpg', { type: 'image/jpeg' })],
            brandingMaterials: [],
            referenceExamples: [],
            isCustomItemType: false,
            customItemType: '',
          ...
          },
          {
            ...
            specialNotes: '',
            referenceImages: [new File(['img2'], 'img2.jpg', { type: 'image/jpeg' })],
            brandingMaterials: [],
            referenceExamples: [],
            isCustomItemType: false,
            customItemType: '',
  ...
  describe('Error Handling', () => {
    ...
    it('should handle webhook errors gracefully', async () => {
      ...
      (triggerMakeWebhook as Mock).mockRejectedValueOnce(new Error('Webhook failed'));
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very large files', async () => {
      ...
      const formDataWithLargeFile = createMockFormData({
        dishes: [{
          id: '1',
          itemType: 'מנה',
          itemName: 'מנה עם תמונה גדולה',
          description: 'מנה עם תמונה גדולה',
          specialNotes: '',
      ...
      const { result } = renderHook(() => 
        useEnhancedFormSubmission({
          clientId: mockClientId,
          formData: formDataWithLargeFile,
          remainingDishes: 5,
          setStepErrors: mockSetStepErrors,
          resetFormData: mockResetFormData
        })
  ...
  describe('Hebrew Language Support', () => {
    ...
    it('should display Hebrew error messages', async () => {
      const { compressImagesBatch } = await import('@/utils/imageCompression');
      (compressImagesBatch as Mock).mockRejectedValueOnce(new Error('Test error'));
