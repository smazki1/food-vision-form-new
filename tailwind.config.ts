	...
	theme: {
		...
		extend: {
			...
			fontFamily: {
				...
				'display': ['Poppins', 'Heebo', 'serif'],
				'hebrew': ['Heebo', 'Inter', 'sans-serif'],
				'inter': ['Inter', 'Heebo', 'sans-serif'],
				'poppins': ['Poppins', 'Heebo', 'sans-serif'],
			...
			boxShadow: {
				...
				'glow': '0 0 30px rgba(139, 30, 63, 0.3)',
				'glow-orange': '0 0 30px rgba(245, 117, 43, 0.3)',
			},
			keyframes: {
				'accordion-down': {
					from: {
